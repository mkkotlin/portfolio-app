          ...
          <div class="lg:col-span-7 space-y-5 sm:space-y-6 text-center lg:text-left">
            ...
            <div class="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3">
              ...
              <a 
                ...
                class="px-5 py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-md shadow-emerald-500/20 hover:scale-105"
              >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                (click)="onOpenResume()"
                class="px-5 py-3.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 text-cyan-300 font-semibold text-sm border border-cyan-500/30 transition-all flex items-center justify-center gap-2 hover:border-cyan-400 shadow-md"
              >
                View Online Resume
              </button>
            </div>
